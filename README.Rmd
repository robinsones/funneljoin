...
For more examples of how to use funneljoin, check out [the vignette](https://cran.r-project.org/web/packages/funneljoin/vignettes/funneljoin.html), which shows different types of joins and the optional arguments, or this [blog post](https://hookedondata.org/introducing-the-funneljoin-package/), which showcases how to use funneljoin analyze questions and answers on StackOverflow. 
